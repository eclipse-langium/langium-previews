...
const Tt = "Canceled";
function Ar(e) {
  return e instanceof Rr ? !0 : e instanceof Error && e.name === Tt && e.message === Tt;
}
...
function Ke(e, t, n = 0, s = e.length) {
  let r = n, i = s;
  for (; r < i; ) {
...
class Vr {
  constructor() {
    this[bn] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
  ...
  [(bn = Symbol.toStringTag, Symbol.iterator)]() {
    return this.entries();
  }
  trimOld(t) {
    if (t >= this.size)
...
class qr extends Vr {
  ...
  set(t, n) {
    return super.set(t, n, 2), this.checkTrim(), this;
  }
  checkTrim() {
...
(function(e) {
  ...
  e.reduce = p;
  function* w(b, L, _ = b.length) {
    for (L < 0 && (L += b.length), _ < 0 ? _ += b.length : _ > b.length && (_ = b.length); L < _; L++)
      yield b[L];
  }
  e.slice = w;
  function v(b, L = Number.POSITIVE_INFINITY) {
    const _ = [];
    if (L === 0)
      return [_, b];
...
const dn = class dn {
  constructor() {
    this._store = new et(), this._store;
  }
  dispose() {
    this._store.dispose();
  }
...
const Hr = globalThis.performance && typeof globalThis.performance.now == "function";
class yt {
  static create(t) {
    return new yt(t);
  }
  constructor(t) {
    this._now = Hr && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(S) {
    return (x, C = null, A) => {
      ...
      return T = S((B) => {
        if (!k)
          return T ? T.dispose() : k = !0, x.call(C, B);
      }, null, A), k && T.dispose(), T;
    };
  }
  e.once = n;
  function s(S, x, C) {
    return c((A, k = null, T) => S((B) => A.call(k, x(B)), null, T), C);
  }
  e.map = s;
  function r(S, x, C) {
    return c((A, k = null, T) => S((B) => {
      x(B), A.call(k, B);
    }, null, T), C);
  }
  e.forEach = r;
  function i(S, x, C) {
    return c((A, k = null, T) => S((B) => x(B) && A.call(k, B), null, T), C);
  }
  e.filter = i;
  function o(S) {
    return S;
  ...
  function l(...S) {
    return (x, C = null, A) => {
      const k = Ir(...S.map((T) => T((B) => x.call(C, B))));
      return h(k, A);
    };
  }
  e.any = l;
  ...
  function f(S, x, C = 100, A = !1, k = !1, T, B) {
    let X, Z, Ee, rt = 0, Se;
    const Lr = {
      leakWarningThreshold: T,
      onWillAddFirstListener() {
        X = S((vr) => {
          rt++, Z = x(Z, vr), A && !Ee && (it.fire(Z), Z = void 0), Se = () => {
            const Nr = Z;
            Z = void 0, Ee = void 0, (!A || rt > 1) && it.fire(Nr), rt = 0;
          }, typeof C == "number" ? (clearTimeout(Ee), Ee = setTimeout(Se, C)) : Ee === void 0 && (Ee = 0, queueMicrotask(Se));
        });
      },
  ...
  function b(S, x, C = (A) => A) {
    const A = (...X) => B.fire(C(...X)), k = () => S.on(x, A), T = () => S.removeListener(x, A), B = new ae(
      { onWillAddFirstListener: k, onDidRemoveLastListener: T }
    );
    return B.event;
  }
  e.fromNodeEventEmitter = b;
  function L(S, x, C = (A) => A) {
    const A = (...X) => B.fire(C(...X)), k = () => S.addEventListener(x, A), T = () => S.removeEventListener(x, A), B = new ae(
      { onWillAddFirstListener: k, onDidRemoveLastListener: T }
    );
    return B.event;
  }
  ...
  function G(S) {
    return (x, C, A) => {
      ...
      const B = {
        ...
        endUpdate() {
          k--, k === 0 && (S.reportChanges(), T && (T = !1, x.call(C)));
        },
      ...
      return A instanceof et ? A.add(X) : Array.isArray(A) && A.push(X), X;
    };
  }
...
class zr {
  ...
  check(t, n) {
    ...
    if (this._stacks.set(t.value, r + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
      ...
      let i, o = 0;
      for (const [l, u] of this._stacks)
        (!i || o < u) && (i = l, o = u);
      console.warn(`[${this.name}] potential listener LEAK detected, having ${n} listeners already. MOST frequent listener (${o}):`), console.warn(i);
    }
    return () => {
...
class ae {
  ...
  get event() {
    return this._event ?? (this._event = (t, n, s) => {
      ...
      const r = new Et(t);
      let i;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = on.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof Et ? (this._deliveryQueue ?? (this._deliveryQueue = new Gr()), this._listeners = [this._listeners, r]) : this._listeners.push(r) : ((u = (l = this._options) == null ? void 0 : l.onWillAddFirstListener) == null || u.call(l, this), this._listeners = r, (h = (c = this._options) == null ? void 0 : c.onDidAddFirstListener) == null || h.call(c, this)), this._size++;
      const o = bt(() => {
        i == null || i(), this._removeListener(r);
      });
      return s instanceof et ? s.add(o) : Array.isArray(s) && s.push(o), o;
    }), this._event;
  }
  _removeListener(t) {
    var i, o, l, u;
  ...
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const s = ((r = this._options) == null ? void 0 : r.onListenerError) || tr;
    if (!s) {
      t.value(n);
      return;
    }
...
let Jr = typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function Yr(e, t) {
  let n;
  ...
  }), Jr && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
let Zr, Kr = {};
function H(e, t, n, ...s) {
  const r = typeof t == "object" ? t.key : t, i = (Kr[e] ?? {})[r] ?? n;
  return Yr(i, s);
}
function ei(e) {
  return Zr;
...
const Pe = "en";
let Ht = !1, Wt = !1, at, ct = Pe, xn = Pe, ie;
const Ae = globalThis;
let K;
var Ks;
typeof Ae.vscode < "u" && typeof Ae.vscode.process < "u" ? K = Ae.vscode.process : typeof process < "u" && typeof ((Ks = process == null ? void 0 : process.versions) == null ? void 0 : Ks.node) == "string" && (K = process);
var er;
const ti = typeof ((er = K == null ? void 0 : K.versions) == null ? void 0 : er.electron) == "string", ni = ti && (K == null ? void 0 : K.type) === "renderer";
if (typeof K == "object") {
  Ht = K.platform === "win32", Wt = K.platform === "darwin", K.platform, K.env.CI || K.env.BUILD_ARTIFACTSTAGINGDIRECTORY, at = Pe, ct = Pe;
  const e = K.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e), n = t.availableLanguages["*"];
      at = t.locale, xn = t.osLocale, ct = n || Pe;
    } catch {
    }
} else
  typeof navigator == "object" && !ni ? (ie = navigator.userAgent, Ht = ie.indexOf("Windows") >= 0, Wt = ie.indexOf("Macintosh") >= 0, (ie.indexOf("Macintosh") >= 0 || ie.indexOf("iPad") >= 0 || ie.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, ie.indexOf("Linux") >= 0, (ie == null ? void 0 : ie.indexOf("Mobi")) >= 0, ei(
    H(
      "vs/base/common/platform",
      { key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] },
      "_"
    )
  ), at = Pe, ct = at, xn = navigator.language) : console.error("Unable to resolve platform.");
var pn;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(pn || (pn = {}));
const tt = Ht, si = Wt, fe = ie, be = ct;
var _n;
(function(e) {
  function t() {
    return be;
...
const ri = typeof Ae.postMessage == "function" && !Ae.importScripts;
(() => {
  if (ri) {
    const e = [];
    Ae.addEventListener("message", (n) => {
    ...
    return (n) => {
      ...
      e.push({
        id: s,
        callback: n
      }), Ae.postMessage({ vscodeScheduleAsyncWork: s }, "*");
    };
  }
...
const ii = !!(fe && fe.indexOf("Chrome") >= 0);
fe && fe.indexOf("Firefox") >= 0;
!ii && fe && fe.indexOf("Safari") >= 0;
fe && fe.indexOf("Edg/") >= 0;
fe && fe.indexOf("Android") >= 0;
const sr = Object.freeze(function(e, t) {
...
class ht {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? sr : (this._emitter || (this._emitter = new ae()), this._emitter.event);
  }
  dispose() {
...
class oi {
  constructor(t, n = JSON.stringify) {
    this.fn = t, this._computeKey = n, this.lastCache = void 0, this.lastArgKey = void 0;
  }
  get(t) {
...
ue.ambiguousCharacterData = new Ln(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}')), ue.cache = new oi((t) => {
  ...
  let o = t.filter((h) => !h.startsWith("_") && h in i);
...
class vi {
  ...
  sendMessage(t, n) {
    ...
    return new Promise((r, i) => {
      this._pendingReplies[s] = {
        resolve: r,
        reject: i
      }, this._send(new pi(this._workerId, s, t, n));
    });
  }
  listen(t, n) {
    let s = null;
    const r = new ae({
      onWillAddFirstListener: () => {
        s = String(++this._lastSentReq), this._pendingEmitters.set(s, r), this._send(new _i(this._workerId, s, t, n));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(s), this._send(new Li(this._workerId, s)), s = null;
      }
    });
    return r.event;
  }
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then((r) => {
      this._send(new vn(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = mn(r.detail)), this._send(new vn(this._workerId, n, void 0, mn(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, s = this._handler.handleEvent(t.eventName, t.arg)((r) => {
      this._send(new wi(this._workerId, n, r));
    });
...
function ir(e) {
  return e[0] === "o" && e[1] === "n" && rr(e.charCodeAt(2));
}
function ar(e) {
  return /^onDynamic/.test(e) && rr(e.charCodeAt(9));
}
function Ni(e, t, n) {
  const s = (o) => function() {
...
class Si {
  constructor(t, n) {
    this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new vi({
      sendMessage: (s, r) => {
        t(s, r);
      },
...
function Ai(e, t, n) {
  return new Le(new Sn(e), new Sn(t)).ComputeDiff(n).changes;
}
class Me {
  static Assert(t, n) {
    if (!t)
...
class Cn {
  ...
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new _e(
...
class Le {
  constructor(t, n, s = null) {
    ...
    const [r, i, o] = Le._getElements(t), [l, u, c] = Le._getElements(n);
  ...
  ComputeDiffRecursive(t, n, s, r, i) {
    ...
    const o = [0], l = [0], u = this.ComputeRecursionPoint(t, n, s, r, o, l, i), c = o[0], h = l[0];
    if (u !== null)
      return u;
    if (!i[0]) {
      ...
      ] : d = this.ComputeDiffRecursive(c + 1, n, h + 1, r, i), this.ConcatenateChanges(f, d);
    }
    return [
      new _e(
        t,
  ...
  WALKTRACE(t, n, s, r, i, o, l, u, c, h, f, d, m, g, p, w, v, N) {
    let b = null, L = null, _ = new Cn(), R = n, y = s, E = m[0] - w[0] - r, I = -1073741824, G = this.m_forwardHistory.length - 1;
    do {
      const S = E + t;
      S === R || S < y && c[S - 1] < c[S + 1] ? (f = c[S + 1], g = f - E - r, f < I && _.MarkNextChange(), I = f, _.AddModifiedElement(f + 1, g), E = S + 1 - t) : (f = c[S - 1] + 1, g = f - E - r, f < I && _.MarkNextChange(), I = f - 1, _.AddOriginalElement(f, g + 1), E = S - 1 - t), G >= 0 && (c = this.m_forwardHistory[G], t = c[0], R = 1, y = c.length - 1);
    } while (--G >= -1);
    if (b = _.getReverseChanges(), N[0]) {
      ...
      _ = new Cn(), R = o, y = l, E = m[0] - w[0] - u, I = 1073741824, G = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const S = E + i;
        S === R || S < y && h[S - 1] >= h[S + 1] ? (f = h[S + 1] - 1, g = f - E - u, f > I && _.MarkNextChange(), I = f + 1, _.AddOriginalElement(f + 1, g + 1), E = S + 1 - i) : (f = h[S - 1], g = f - E - u, f > I && _.MarkNextChange(), I = f, _.AddModifiedElement(f + 1, g + 1), E = S - 1 - i), G >= 0 && (h = this.m_reverseHistory[G], i = h[0], R = 1, y = h.length - 1);
      } while (--G >= -1);
      L = _.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, s, r, i, o, l) {
    ...
    const g = n - t + (r - s), p = g + 1, w = new Int32Array(p), v = new Int32Array(p), N = r - s, b = n - t, L = t - s, _ = n - r, y = (b - N) % 2 === 0;
    w[N] = t, v[b] = n, l[0] = !1;
    for (let E = 1; E <= g / 2 + 1; E++) {
      let I = 0, G = 0;
      h = this.ClipDiagonalBound(N - E, E, N, p), f = this.ClipDiagonalBound(N + E, E, N, p);
      for (let x = h; x <= f; x += 2) {
        x === h || x < f && w[x - 1] < w[x + 1] ? u = w[x + 1] : u = w[x - 1] + 1, c = u - (x - N) - L;
        const C = u;
        for (; u < n && c < r && this.ElementsAreEqual(u + 1, c + 1); )
          u++, c++;
        if (w[x] = u, u + c > I + G && (I = u, G = c), !y && Math.abs(x - b) <= E - 1 && u >= v[x])
          return i[0] = u, o[0] = c, C <= v[x] && E <= 1448 ? this.WALKTRACE(N, h, f, L, b, d, m, _, w, v, u, n, i, c, r, o, y, l) : null;
      }
      const S = (I - t + (G - s) - E) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(I, S))
        return l[0] = !0, i[0] = I, o[0] = G, S > 0 && E <= 1448 ? this.WALKTRACE(N, h, f, L, b, d, m, _, w, v, u, n, i, c, r, o, y, l) : (t++, s++, [
          new _e(
            t,
            n - t + 1,
            s,
      ...
      d = this.ClipDiagonalBound(b - E, E, b, p), m = this.ClipDiagonalBound(b + E, E, b, p);
      for (let x = d; x <= m; x += 2) {
        x === d || x < m && v[x - 1] >= v[x + 1] ? u = v[x + 1] - 1 : u = v[x - 1], c = u - (x - b) - _;
        const C = u;
        for (; u > t && c > s && this.ElementsAreEqual(u, c); )
          u--, c--;
        if (v[x] = u, y && Math.abs(x - N) <= E && u <= w[x])
          return i[0] = u, o[0] = c, C >= w[x] && E <= 1448 ? this.WALKTRACE(N, h, f, L, b, d, m, _, w, v, u, n, i, c, r, o, y, l) : null;
      }
      if (E <= 1447) {
        let x = new Int32Array(f - h + 2);
        x[0] = N - h + 1, ke.Copy2(w, h, x, 1, f - h + 1), this.m_forwardHistory.push(x), x = new Int32Array(m - d + 2), x[0] = b - d + 1, ke.Copy2(v, d, x, 1, m - d + 1), this.m_reverseHistory.push(x);
      }
    }
    return this.WALKTRACE(N, h, f, L, b, d, m, _, w, v, u, n, i, c, r, o, y, l);
  }
  PrettifyChanges(t) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let f = 1; ; f++) {
        ...
        if (d < r || m < i || o && !this.OriginalElementsAreEqual(d, d + s.originalLength) || l && !this.ModifiedElementsAreEqual(m, m + s.modifiedLength))
          break;
        const p = (d === r && m === i ? 5 : 0) + this._boundaryScore(d, s.originalLength, m, s.modifiedLength);
        p > c && (c = p, u = f);
      }
    ...
    if (this._hasStrings)
      for (let n = 1, s = t.length; n < s; n++) {
        const r = t[n - 1], i = t[n], o = i.originalStart - r.originalStart - r.originalLength, l = r.originalStart, u = i.originalStart + i.originalLength, c = u - l, h = r.modifiedStart, f = i.modifiedStart + i.modifiedLength, d = f - h;
        if (o < 5 && c < 20 && d < 20) {
          const m = this._findBetterContiguousSequence(l, c, h, d, o);
          if (m) {
            const [g, p] = m;
            (g !== r.originalStart + r.originalLength || p !== r.modifiedStart + r.modifiedLength) && (r.originalLength = g - r.originalStart, r.modifiedLength = p - r.modifiedStart, i.originalStart = g + o, i.modifiedStart = p + o, i.originalLength = u - i.originalStart, i.modifiedLength = f - i.modifiedStart);
          }
        }
      }
    return t;
  ...
  ChangesOverlap(t, n, s) {
    if (Me.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Me.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (i = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), s[0] = new _e(r, i, o, l), !0;
    } else
      return s[0] = null, !1;
  }
...
if (typeof Mt < "u" && typeof Mt.process < "u") {
  ...
  typeof process < "u" ? Re = {
    ...
    get platform() {
      return tt ? "win32" : si ? "darwin" : "linux";
    },
    get arch() {
    },
    get env() {
...
const pt = Re.cwd, Ri = Re.env, yi = Re.platform;
Re.arch;
const Ei = 65, Mi = 97, ki = 90, Fi = 122, ve = 46, Q = 47, ee = 92, xe = 58, Di = 63;
...
function _t(e, t, n, s) {
  ...
  for (let c = 0; c <= e.length; ++c) {
    ...
    if (s(u)) {
      if (!(o === c - 1 || l === 1))
        if (l === 2) {
          if (r.length < 2 || i !== 2 || r.charCodeAt(r.length - 1) !== ve || r.charCodeAt(r.length - 2) !== ve) {
            if (r.length > 2) {
              const h = r.lastIndexOf(n);
              h === -1 ? (r = "", i = 0) : (r = r.slice(0, h), i = r.length - 1 - r.lastIndexOf(n)), o = c, l = 0;
              continue;
            } else if (r.length !== 0) {
              r = "", i = 0, o = c, l = 0;
              continue;
...
const O = {
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        ...
        t.length === 0 ? i = pt() : (i = Ri[`=${t}`] || pt(), (i === void 0 || i.slice(0, 2).toLowerCase() !== t.toLowerCase() && i.charCodeAt(2) === ee) && (i = `${t}\\`));
      const o = i.length;
      let l = 0, u = "", c = !1;
      ...
      if (o === 1)
        ...
        if (c = !0, P(i.charCodeAt(1))) {
          let f = 2, d = f;
          for (; f < o && !P(i.charCodeAt(f)); )
            f++;
          if (f < o && f !== d) {
            const m = i.slice(d, f);
            for (d = f; f < o && P(i.charCodeAt(f)); )
              f++;
            if (f < o && f !== d) {
              for (d = f; f < o && !P(i.charCodeAt(f)); )
                f++;
              (f === o || f !== d) && (u = `\\\\${m}\\${i.slice(d, f)}`, l = f);
            }
          }
        } else
          l = 1;
      else
        pe(h) && i.charCodeAt(1) === xe && (u = i.slice(0, 2), l = 2, o > 2 && P(i.charCodeAt(2)) && (c = !0, l = 3));
      if (u.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (P(i))
      if (r = !0, P(e.charCodeAt(1))) {
        let l = 2, u = l;
        for (; l < t && !P(e.charCodeAt(l)); )
          l++;
        if (l < t && l !== u) {
          const c = e.slice(u, l);
          for (u = l; l < t && P(e.charCodeAt(l)); )
            l++;
          if (l < t && l !== u) {
            for (u = l; l < t && !P(e.charCodeAt(l)); )
              l++;
      ...
      pe(i) && e.charCodeAt(1) === xe && (s = e.slice(0, 2), n = 2, t > 2 && P(e.charCodeAt(2)) && (r = !0, n = 3));
    let o = n < t ? _t(e.slice(n), !r, "\\", P) : "";
    return o.length === 0 && !r && (o = "."), o.length > 0 && P(e.charCodeAt(t - 1)) && (o += "\\"), s === void 0 ? r ? `\\${o}` : o : r ? `${s}\\${o}` : `${s}${o}`;
  },
  isAbsolute(e) {
    $(e, "path");
    const t = e.length;
    ...
    return P(n) || t > 2 && pe(n) && e.charCodeAt(1) === xe && P(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let i = 0; i < e.length; ++i) {
      const o = e[i];
      $(o, "path"), o.length > 0 && (t === void 0 ? t = n = o : t += `\\${o}`);
    }
    if (t === void 0)
      return ".";
    let s = !0, r = 0;
  ...
  relative(e, t) {
    ...
    if (d !== h) {
      ...
      o > h && (e.charCodeAt(r + d) === ee ? f = d : d === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let m = "";
    for (d = r + f + 1; d <= i; ++d)
      (d === i || e.charCodeAt(d) === ee) && (m += m.length === 0 ? ".." : "\\..");
  ...
  toNamespacedPath(e) {
    ...
    } else if (pe(t.charCodeAt(0)) && t.charCodeAt(1) === xe && t.charCodeAt(2) === ee)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    if (P(r)) {
      ...
      pe(r) && e.charCodeAt(1) === xe && (n = t > 2 && P(e.charCodeAt(2)) ? 3 : 2, s = n);
    let i = -1, o = !0;
    for (let l = t - 1; l >= s; --l)
      if (P(e.charCodeAt(l))) {
        if (!o) {
  ...
  basename(e, t) {
    ...
    let n = 0, s = -1, r = !0, i;
    if (e.length >= 2 && pe(e.charCodeAt(0)) && e.charCodeAt(1) === xe && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === xe && pe(e.charCodeAt(0)) && (t = s = 2);
    for (let l = e.length - 1; l >= t; --l) {
      ...
      r === -1 && (i = !1, r = l + 1), u === ve ? n === -1 ? n = l : o !== 1 && (o = 1) : n !== -1 && (o = -1);
    }
    return n === -1 || r === -1 || o === 0 || o === 1 && n === r - 1 && n === s + 1 ? "" : e.slice(n, r);
  },
  format: lr.bind(null, "\\"),
  parse(e) {
    $(e, "path");
    ...
    } else if (pe(r) && e.charCodeAt(1) === xe) {
      if (n <= 2)
    ...
    let i = -1, o = s, l = -1, u = !0, c = e.length - 1, h = 0;
    for (; c >= s; --c) {
      ...
      l === -1 && (u = !1, l = c + 1), r === ve ? i === -1 ? i = c : h !== 1 && (h = 1) : i !== -1 && (h = -1);
    }
    return l !== -1 && (i === -1 || h === 0 || h === 1 && i === l - 1 && i === o + 1 ? t.base = t.name = e.slice(o, l) : (t.name = e.slice(o, i), t.base = e.slice(o, l), t.ext = e.slice(i, l))), o > 0 && o !== s ? t.dir = e.slice(0, o - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  relative(e, t) {
    ...
    if (c === l)
      if (o > l) {
        ...
        r > l && (e.charCodeAt(n + c) === Q ? u = c : c === 0 && (u = 0));
    let h = "";
    for (c = n + u + 1; c <= s; ++c)
  ...
  extname(e) {
    ...
    for (let o = e.length - 1; o >= 0; --o) {
      ...
      s === -1 && (r = !1, s = o + 1), l === ve ? t === -1 ? t = o : i !== 1 && (i = 1) : t !== -1 && (i = -1);
    }
  ...
  parse(e) {
    ...
    for (; u >= s; --u) {
      ...
      o === -1 && (l = !1, o = u + 1), h === ve ? r === -1 ? r = u : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (o !== -1) {
      const h = i === 0 && n ? 1 : i;
      r === -1 || c === 0 || c === 1 && r === o - 1 && r === i + 1 ? t.base = t.name = e.slice(h, o) : (t.name = e.slice(h, r), t.base = e.slice(h, o), t.ext = e.slice(r, o));
    }
...
class ye {
  ...
  constructor(t, n, s, r, i, o = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || U, this.authority = t.authority || U, this.path = t.path || U, this.query = t.query || U, this.fragment = t.fragment || U) : (this.scheme = Ui(t, o), this.authority = n || U, this.path = Hi(this.scheme, s || U), this.query = r || U, this.fragment = i || U, Ii(this, o));
  }
  get fsPath() {
    return jt(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = U), s === void 0 ? s = this.authority : s === null && (s = U), r === void 0 ? r = this.path : r === null && (r = U), i === void 0 ? i = this.query : i === null && (i = U), o === void 0 ? o = this.fragment : o === null && (o = U), n === this.scheme && s === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new Fe(n, s, r, i, o);
  }
  static parse(t, n = !1) {
    const s = Wi.exec(t);
    return s ? new Fe(
  ...
  static joinPath(t, ...n) {
    ...
    let s;
    return tt && t.scheme === "file" ? s = ye.file(O.join(jt(t, !0), ...n)).path : s = Y.join(t.path, ...n), t.with({ path: s });
  }
  toString(t = !1) {
    return Gt(this, t);
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new Fe(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === ur ? t.fsPath ?? null : null, n;
      }
    } else
      return t;
  }
}
const ur = tt ? 1 : void 0;
class Fe extends ye {
  constructor() {
  ...
  toString(t = !1) {
    return t ? Gt(this, !0) : (this._formatted || (this._formatted = Gt(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    };
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = ur), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const cr = {
  58: "%3A",
...
function zi(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const s = e.charCodeAt(n);
    s === 35 || s === 63 ? (t === void 0 && (t = e.substr(0, n)), t += cr[s]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function jt(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, tt && (n = n.replace(/\//g, "\\")), n;
}
function Gt(e, t) {
  const n = t ? zi : An;
  let s = "", { scheme: r, authority: i, path: o, query: l, fragment: u } = e;
  if (r && (s += r, s += ":"), (i || r === "file") && (s += oe, s += oe), i) {
    let c = i.indexOf("@");
    if (c !== -1) {
  ...
  return l && (s += "?", s += n(l, !1, !1)), u && (s += "#", s += t ? u : An(u, !1, !1)), s;
}
function hr(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + hr(e.substr(3)) : e;
  }
}
const Rn = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function ot(e) {
  return e.match(Rn) ? e.replace(Rn, (t) => hr(t)) : e;
}
class J {
  constructor(t, n) {
...
class D {
  ...
  static intersectRanges(t, n) {
    ...
    return s < l ? (s = l, r = u) : s === l && (r = Math.max(r, u)), i > c ? (i = c, o = h) : i === c && (o = Math.min(o, h)), s > i || s === i && r > o ? null : new D(
      s,
      r,
      i,
      o
...
class $i {
  ...
  setValue(t, n) {
    return t = De(t), n = De(n), this.values[t] === n ? !1 : (this.values[t] = n, t - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = t - 1), !0);
  }
  removeValues(t, n) {
    t = De(t), n = De(n);
...
function ln(e, t, n, s, r) {
  if (t = dr(t), r || (r = gt.first(mr)), n.length > r.maxLen) {
    let c = e - r.maxLen / 2;
    return c < 0 ? c = 0 : s += c, n = n.substring(c, e + r.maxLen / 2), ln(e, t, n, s, r);
  }
  const i = Date.now(), o = e - 1 - s;
  let l = -1, u = null;
  for (let c = 1; !(Date.now() - i >= r.timeBudget); c++) {
    const h = o - r.windowSize * c;
...
function Ki() {
  if (Oe === null) {
    ...
    const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
    for (let n = 0; n < e.length; n++)
      Oe.set(e.charCodeAt(n), 1);
    const t = ".,;:";
    for (let n = 0; n < t.length; n++)
      Oe.set(t.charCodeAt(n), 2);
  }
  return Oe;
}
class wt {
    ...
    for (let i = 1, o = t.getLineCount(); i <= o; i++) {
      ...
      for (; c < u; ) {
        ...
        if (d === 13) {
          ...
          b === 1 && (r.push(wt._createLink(s, l, i, h, c)), v = !0);
        } else if (d === 12) {
          let b;
          N === 91 ? (g = !0, b = 0) : b = s.get(N), b === 1 ? v = !0 : d = 13;
        } else
          d = n.nextState(d, N), d === 0 && (v = !0);
        v && (d = 1, m = !1, g = !1, w = !1, h = c + 1, f = N), c++;
      }
      d === 13 && r.push(wt._createLink(s, l, i, h, u));
    }
    return r;
  }
}
function ea(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : wt.computeLinks(e);
}
const At = class At {
  constructor() {
...
const ft = new cn(), Xt = new cn(), Qt = new cn(), ta = new Array(230), na = /* @__PURE__ */ Object.create(null), sa = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    const [i, o, l, u, c, h, f, d, m] = r;
    if (s[o] || (s[o] = !0, na[l] = o, sa[l.toLowerCase()] = o), !n[u]) {
      if (n[u] = !0, !c)
        throw new Error(`String representation missing for key code ${u} around scan code ${l}`);
      ft.define(u, c), Xt.define(u, d || c), Qt.define(u, m || d || c);
    }
    h && (ta[h] = u);
  }
})();
...
(function(e) {
  function t(l) {
    return ft.keyCodeToStr(l);
  }
  e.toString = t;
  function n(l) {
    return ft.strToKeyCode(l);
  }
  e.fromString = n;
  function s(l) {
...
function da(e, t, n, s, r) {
  return ha(e, t, n, s, r) && fa(e, t, n, s, r);
}
class ma {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
        if (i === 0) {
          mi(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || da(this._wordSeparators, t, n, r, i))
        return s;
    } while (s);
    return null;
  }
}
function ga(e, t = "Unreachable") {
  throw new Error(t);
}
function Lt(e) {
  if (!e()) {
    debugger;
    e(), tr(new he("Assertion Failed"));
  }
}
function gr(e, t) {
  let n = 0;
...
class ba {
  static computeUnicodeHighlights(t, n, s) {
    const r = s ? s.startLineNumber : 1, i = s ? s.endLineNumber : t.getLineCount(), o = new Vs(n), l = o.getCandidateCodePoints();
    let u;
    l === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${xa(Array.from(l))}`, "g");
    const c = new ma(null, u), h = [];
    let f = !1, d, m = 0, g = 0, p = 0;
    e:
      for (let w = r, v = i; w <= v; w++) {
        const N = t.getLineContent(w), b = N.length;
        c.reset(0);
        do
          if (d = c.next(N), d) {
            let L = d.index, _ = d.index + d[0].length;
            if (L > 0) {
              const I = N.charCodeAt(L - 1);
              zt(I) && L--;
            }
            if (_ + 1 < b) {
            ...
            const R = N.substring(L, _);
            let y = ln(L + 1, fr, N, 0);
            y && y.endColumn <= L + 1 && (y = null);
            const E = o.shouldHighlightNonBasicASCII(R, y ? y.word : null);
            if (E !== 0) {
              if (E === 3 ? m++ : E === 2 ? g++ : E === 1 ? p++ : ga(), h.length >= 1e3) {
                f = !0;
                break e;
              }
              h.push(new D(w, L + 1, w, _ + 1));
            }
          }
        while (d);
      }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (s.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 2:
        return { kind: 1 };
      case 3: {
        const i = t.codePointAt(0), o = s.ambiguousCharacters.getPrimaryConfusable(i), l = nt.getLocales().filter((u) => !nt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, u])).isAmbiguous(i));
...
function xa(e, t) {
  return `[${li(e.map((s) => String.fromCodePoint(s)).join(""))}]`;
}
class Vs {
  constructor(t) {
    this.options = t, this.allowedCodePoints = new Set(t.allowedCodePoints), this.ambiguousCharacters = nt.getInstance(new Set(t.allowedLocales));
  }
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Je.codePoints)
        qs(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const o of n) {
        const l = o.codePointAt(0), u = bi(o);
        r = r || u, !u && !this.ambiguousCharacters.isAmbiguous(l) && !Je.isInvisibleCharacter(l) && (i = !0);
      }
    return !r && i ? 0 : this.options.invisibleCharacters && !qs(t) && Je.isInvisibleCharacter(s) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(s) ? 3 : 0;
  }
}
function qs(e) {
  return e === " " || e === `
...
class F {
  ...
  constructor(t, n) {
    if (t > n)
      throw new he(`startLineNumber ${t} cannot be after endLineNumberExclusive ${n}`);
...
class ce {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Vt(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), s = Ke(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === s)
  ...
  getUnion(t) {
    ...
    for (; s < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
      ...
      i === null ? i = o : i.endLineNumberExclusive >= o.startLineNumber ? i = new F(
        i.startLineNumber,
  ...
  subtractFrom(t) {
    const n = Vt(this._normalizedRanges, (o) => o.endLineNumberExclusive >= t.startLineNumber), s = Ke(this._normalizedRanges, (o) => o.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === s)
      return new ce([t]);
    const r = [];
    ...
    for (let o = n; o < s; o++) {
      ...
      l.startLineNumber > i && r.push(new F(i, l.startLineNumber)), i = l.endLineNumberExclusive;
    }
    return i < t.endLineNumberExclusive && r.push(new F(i, t.endLineNumberExclusive)), new ce(r);
  }
  toString() {
...
class le {
  static inverse(t, n, s) {
    ...
    let i = 1, o = 1;
    for (const u of t) {
      const c = new le(new F(i, u.original.startLineNumber), new F(o, u.modified.startLineNumber));
      c.modified.isEmpty || r.push(c), i = u.original.endLineNumberExclusive, o = u.modified.endLineNumberExclusive;
    }
    const l = new le(new F(i, n + 1), new F(o, s + 1));
  ...
  static clip(t, n, s) {
    ...
    for (const i of t) {
      ...
      o && !o.isEmpty && l && !l.isEmpty && r.push(new le(o, l));
    }
    return r;
  }
  constructor(t, n) {
...
class me extends le {
  static fromRangeMappings(t) {
    const n = F.join(t.map((r) => F.fromRangeInclusive(r.originalRange))), s = F.join(t.map((r) => F.fromRangeInclusive(r.modifiedRange)));
    return new me(n, s, t);
  }
  constructor(t, n, s) {
  ...
  withInnerChangesFromLineRanges() {
    return new me(this.original, this.modified, [
      new je(this.original.toExclusiveRange(), this.modified.toExclusiveRange())
    ]);
  }
}
class je {
...
class _a {
  computeDiff(t, n, s) {
    ...
    for (const c of i.changes) {
      let h;
      c.originalEndLineNumber === 0 ? h = new F(c.originalStartLineNumber + 1, c.originalStartLineNumber + 1) : h = new F(c.originalStartLineNumber, c.originalEndLineNumber + 1);
      let f;
      c.modifiedEndLineNumber === 0 ? f = new F(c.modifiedStartLineNumber + 1, c.modifiedStartLineNumber + 1) : f = new F(c.modifiedStartLineNumber, c.modifiedEndLineNumber + 1);
      let d = new me(h, f, (u = c.charChanges) == null ? void 0 : u.map((m) => new je(new D(
      ...
      l && (l.modified.endLineNumberExclusive === d.modified.startLineNumber || l.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new me(
    ...
    return Lt(() => gr(o, (c, h) => h.original.startLineNumber - c.original.endLineNumberExclusive === h.modified.startLineNumber - c.modified.endLineNumberExclusive && c.original.endLineNumberExclusive < h.original.startLineNumber && c.modified.endLineNumberExclusive < h.modified.startLineNumber)), new dt(o, [], i.quitEarly);
  }
}
function br(e, t, n, s) {
...
function La(e) {
  ...
  for (let s = 1, r = e.length; s < r; s++) {
    ...
    Math.min(o, l) < pa ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (t.push(i), n = i);
  }
  return t;
}
class Ye {
  ...
  static createFromDiffResult(t, n, s, r, i, o, l) {
    ...
    if (n.originalLength === 0 ? (u = s.getStartLineNumber(n.originalStart) - 1, c = 0) : (u = s.getStartLineNumber(n.originalStart), c = s.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = r.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = r.getStartLineNumber(n.modifiedStart), f = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), o && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
      ...
      if (m.getElements().length > 0 && g.getElements().length > 0) {
        let p = br(m, g, i, !0).changes;
        l && (p = La(p)), d = [];
        for (let w = 0, v = p.length; w < v; w++)
          d.push(He.createFromDiffChange(p[w], m, g));
      }
    }
    return new Ye(
      u,
...
class xr {
  constructor(t, n, s) {
    this.shouldComputeCharChanges = s.shouldComputeCharChanges, this.shouldPostProcessCharChanges = s.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = s.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = s.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Bs(t), this.modified = new Bs(n), this.continueLineDiff = Is(s.maxComputationTime), this.continueCharDiff = Is(s.maxComputationTime === 0 ? 0 : Math.min(s.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = br(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, s = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let u = 0, c = n.length; u < c; u++)
        l.push(Ye.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[u], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: s,
        changes: l
      };
    ...
    for (let l = -1, u = n.length; l < u; l++) {
      ...
      for (; i < h && o < f; ) {
        ...
        if (d !== m) {
          {
            let g = tn(d, 1), p = tn(m, 1);
            for (; g > 1 && p > 1; ) {
              const w = d.charCodeAt(g - 2), v = m.charCodeAt(p - 2);
              if (w !== v)
                break;
              g--, p--;
            }
            (g > 1 || p > 1) && this._pushTrimWhitespaceCharChange(r, i + 1, 1, g, o + 1, 1, p);
          }
          {
            let g = nn(d, 1), p = nn(m, 1);
            const w = d.length + 1, v = m.length + 1;
            for (; g < w && p < v; ) {
            ...
            (g < w || p < v) && this._pushTrimWhitespaceCharChange(r, i + 1, g, w, o + 1, p, v);
          }
        }
        i++, o++;
      }
      c && (r.push(Ye.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += c.originalLength, o += c.modifiedLength);
    }
    return {
      quitEarly: s,
      changes: r
...
class ge {
  static trivial(t, n) {
    return new ge([new z(V.ofLength(t.length), V.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new ge([new z(V.ofLength(t.length), V.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class z {
  static invert(t, n) {
    const s = [];
    return Fr(t, (r, i) => {
      s.push(z.fromOffsetPairs(r ? r.getEndExclusives() : de.zero, i ? i.getStarts() : new de(
        n,
...
const Ce = class Ce {
  ...
  delta(t) {
    return t === 0 ? this : new Ce(this.offset1 + t, this.offset2 + t);
  }
  equals(t) {
    return this.offset1 === t.offset1 && this.offset2 === t.offset2;
  }
};
Ce.zero = new Ce(0, 0), Ce.max = new Ce(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
let de = Ce;
const Rt = class Rt {
  isValid() {
    return !0;
...
Ze.chrKeys = /* @__PURE__ */ new Map();
let vt = Ze;
class Na {
  compute(t, n, s = st.instance, r) {
    if (t.length === 0 || n.length === 0)
      return ge.trivial(t, n);
    const i = new Ft(t.length, n.length), o = new Ft(t.length, n.length), l = new Ft(t.length, n.length);
    for (let g = 0; g < t.length; g++)
      for (let p = 0; p < n.length; p++) {
        if (!s.isValid())
          return ge.trivialTimedOut(t, n);
        const w = g === 0 ? 0 : i.get(g - 1, p), v = p === 0 ? 0 : i.get(g, p - 1);
        let N;
        t.getElement(g) === n.getElement(p) ? (g === 0 || p === 0 ? N = 0 : N = i.get(g - 1, p - 1), g > 0 && p > 0 && o.get(g - 1, p - 1) === 3 && (N += l.get(g - 1, p - 1)), N += r ? r(g, p) : 1) : N = -1;
        const b = Math.max(w, v, N);
        if (b === N) {
          const L = g > 0 && p > 0 ? l.get(g - 1, p - 1) : 0;
          l.set(g, p, L + 1), o.set(g, p, 3);
        } else
          b === w ? (l.set(g, p, 0), o.set(g, p, 1)) : b === v && (l.set(g, p, 0), o.set(g, p, 2));
        i.set(g, p, b);
      }
    const u = [];
    ...
    for (; d >= 0 && m >= 0; )
      o.get(d, m) === 3 ? (f(d, m), d--, m--) : o.get(d, m) === 1 ? d-- : m--;
    return f(-1, -1), u.reverse(), new ge(u, !1);
  }
}
class pr {
  compute(t, n, s = st.instance) {
    ...
    const r = t, i = n;
    function o(p, w) {
      for (; p < r.length && w < i.length && r.getElement(p) === i.getElement(w); )
        p++, w++;
      return p;
    }
    let l = 0;
    ...
    u.set(0, o(0, 0));
    const c = new Ca();
    c.set(0, u.get(0) === 0 ? null : new Us(null, 0, 0, u.get(0)));
    let h = 0;
    e:
      for (; ; ) {
        if (l++, !s.isValid())
          return ge.trivialTimedOut(r, i);
        const p = -Math.min(l, i.length + l % 2), w = Math.min(l, r.length + l % 2);
        for (h = p; h <= w; h += 2) {
          const v = h === w ? -1 : u.get(h + 1), N = h === p ? -1 : u.get(h - 1) + 1, b = Math.min(Math.max(v, N), r.length), L = b - h;
          if (b > r.length || L > i.length)
            continue;
          const _ = o(b, L);
          u.set(h, _);
          const R = b === v ? c.get(h + 1) : c.get(h - 1);
          if (c.set(h, _ !== b ? new Us(R, b, L, _ - b) : R), u.get(h) === r.length && u.get(h) - h === i.length)
            break e;
        }
      }
    let f = c.get(h);
    ...
    for (; ; ) {
      ...
      if ((p !== m || w !== g) && d.push(new z(new V(p, m), new V(w, g))), !f)
        break;
      m = f.x, g = f.y, f = f.prev;
    }
    return d.reverse(), new ge(d, !1);
  }
}
class Us {
  constructor(t, n, s, r) {
...
class Nt {
  constructor(t, n, s) {
    ...
    for (let i = this.lineRange.start; i < this.lineRange.endExclusive; i++) {
      ...
      if (r)
        ...
        const u = o.trimStart();
        l = o.length - u.length, o = u.trimEnd();
      }
      this.additionalOffsetByLine.push(l);
      for (let u = 0; u < o.length; u++)
        this.elements.push(o.charCodeAt(u));
  ...
  getBoundaryScore(t) {
    const n = Ws(t > 0 ? this.elements[t - 1] : -1), s = Ws(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && s === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== s && (r += 10, n === 0 && s === 1 && (r += 1)), r += Hs(n), r += Hs(s), r;
  }
  translateOffset(t) {
    if (this.lineRange.isEmpty)
      return new J(this.lineRange.start + 1, 1);
    const n = Ke(this.firstCharOffsetByLine, (s) => s <= t);
    return new J(
  ...
  findWordContaining(t) {
    ...
    for (; n > 0 && Dt(this.elements[n - 1]); )
      n--;
    let s = t;
    for (; s < this.elements.length && Dt(this.elements[s]); )
      s++;
    return new V(n, s);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = ze(this.firstCharOffsetByLine, (r) => r <= t.start) ?? 0, s = Er(this.firstCharOffsetByLine, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new V(n, s);
  }
}
function Dt(e) {
...
function Ra(e, t, n, s, r, i) {
  let { moves: o, excludedChanges: l } = Ea(e, t, n, i);
  if (!i.isValid())
    return [];
  const u = e.filter((h) => !l.has(h)), c = Ma(u, s, r, t, n, i);
  return Pr(o, c), o = ka(o), o = o.filter((h) => {
    const f = h.original.toOffsetRange().slice(t).map((m) => m.trim());
    return f.join(`
`).length >= 15 && ya(f, (m) => m.length >= 2) >= 2;
  }), o = Fa(e, o), o;
}
function ya(e, t) {
  let n = 0;
...
function Ea(e, t, n, s) {
  const r = [], i = e.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new vt(u.original, t, u)), o = new Set(e.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new vt(u.modified, n, u))), l = /* @__PURE__ */ new Set();
  for (const u of i) {
    let c = -1, h;
    for (const f of o) {
    ...
    if (c > 0.9 && h && (o.delete(h), r.push(new le(u.range, h.range)), l.add(u.source), l.add(h.source)), !s.isValid())
      return { moves: r, excludedChanges: l };
  }
  return { moves: r, excludedChanges: l };
}
function Ma(e, t, n, s, r, i) {
  const o = [], l = new Br();
  for (const d of e)
    for (let m = d.original.startLineNumber; m < d.original.endLineNumberExclusive - 2; m++) {
      const g = `${t[m - 1]}:${t[m + 1 - 1]}:${t[m + 2 - 1]}`;
      l.add(g, { range: new F(m, m + 3) });
    }
  const u = [];
  e.sort(lt((d) => d.modified.startLineNumber, ut));
  for (const d of e) {
    let m = [];
    for (let g = d.modified.startLineNumber; g < d.modified.endLineNumberExclusive - 2; g++) {
      const p = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, w = new F(g, g + 3), v = [];
      l.forEach(p, ({ range: N }) => {
        for (const L of m)
          if (L.originalLineRange.endLineNumberExclusive + 1 === N.endLineNumberExclusive && L.modifiedLineRange.endLineNumberExclusive + 1 === w.endLineNumberExclusive) {
            L.originalLineRange = new F(
              L.originalLineRange.startLineNumber,
              N.endLineNumberExclusive
            ), L.modifiedLineRange = new F(
  ...
  u.sort(Tr(lt((d) => d.modifiedLineRange.length, ut)));
  const c = new ce(), h = new ce();
  for (const d of u) {
    const m = d.modifiedLineRange.startLineNumber - d.originalLineRange.startLineNumber, g = c.subtractFrom(d.modifiedLineRange), p = h.subtractFrom(d.originalLineRange).getWithDelta(m), w = g.getIntersection(p);
    for (const v of w.ranges) {
      if (v.length < 3)
        continue;
      const N = v, b = v.delta(-m);
      o.push(new le(b, N)), c.addRange(N), h.addRange(b);
    }
  }
  o.sort(lt((d) => d.original.startLineNumber, ut));
  const f = new mt(e);
  for (let d = 0; d < o.length; d++) {
    const m = o[d], g = f.findLastMonotonous((R) => R.original.startLineNumber <= m.original.startLineNumber), p = ze(e, (R) => R.modified.startLineNumber <= m.modified.startLineNumber), w = Math.max(m.original.startLineNumber - g.original.startLineNumber, m.modified.startLineNumber - p.modified.startLineNumber), v = f.findLastMonotonous((R) => R.original.startLineNumber < m.original.endLineNumberExclusive), N = ze(e, (R) => R.modified.startLineNumber < m.modified.endLineNumberExclusive), b = Math.max(v.original.endLineNumberExclusive - m.original.endLineNumberExclusive, N.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
    let L;
    for (L = 0; L < w; L++) {
      const R = m.original.startLineNumber - L - 1, y = m.modified.startLineNumber - L - 1;
      if (R > s.length || y > r.length || c.contains(y) || h.contains(R) || !zs(s[R - 1], r[y - 1], i))
        break;
    }
    L > 0 && (h.addRange(new F(m.original.startLineNumber - L, m.original.startLineNumber)), c.addRange(new F(m.modified.startLineNumber - L, m.modified.startLineNumber)));
    let _;
    for (_ = 0; _ < b; _++) {
      const R = m.original.endLineNumberExclusive + _, y = m.modified.endLineNumberExclusive + _;
      if (R > s.length || y > r.length || c.contains(y) || h.contains(R) || !zs(s[R - 1], r[y - 1], i))
        break;
    }
    _ > 0 && (h.addRange(new F(
...
function zs(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new pr().compute(new Nt([e], new V(0, 1), !1), new Nt([t], new V(0, 1), !1), n);
  let i = 0;
...
function ka(e) {
  if (e.length === 0)
    return e;
  e.sort(lt((n) => n.original.startLineNumber, ut));
  const t = [e[0]];
...
function Fa(e, t) {
  const n = new mt(e);
  return t = t.filter((s) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < s.original.endLineNumberExclusive) || new le(new F(1, 1), new F(1, 1)), i = ze(e, (l) => l.modified.startLineNumber < s.modified.endLineNumberExclusive);
    return r !== i;
  }), t;
}
function $s(e, t, n) {
  let s = n;
  return s = js(e, t, s), s = js(e, t, s), s = Da(e, t, s), s;
}
function js(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let i = 1; i < n.length; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= u && !(e.getElement(l.seq1Range.start - c) !== e.getElement(l.seq1Range.endExclusive - c) || t.getElement(l.seq2Range.start - c) !== t.getElement(l.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === u) {
        s[s.length - 1] = new z(new V(o.seq1Range.start, l.seq1Range.endExclusive - u), new V(o.seq2Range.start, l.seq2Range.endExclusive - u));
        continue;
      }
      l = l.delta(-c);
    }
  ...
  for (let i = 0; i < s.length - 1; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 0; c < u && !(!e.isStronglyEqual(l.seq1Range.start + c, l.seq1Range.endExclusive + c) || !t.isStronglyEqual(l.seq2Range.start + c, l.seq2Range.endExclusive + c)); c++)
        ;
      if (c === u) {
        s[i + 1] = new z(new V(l.seq1Range.start + u, o.seq1Range.endExclusive), new V(l.seq2Range.start + u, o.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (l = l.delta(c));
    }
...
function Da(e, t, n) {
  ...
  for (let s = 0; s < n.length; s++) {
    const r = s > 0 ? n[s - 1] : void 0, i = n[s], o = s + 1 < n.length ? n[s + 1] : void 0, l = new V(
    ...
    i.seq1Range.isEmpty ? n[s] = Gs(i, e, t, l, u) : i.seq2Range.isEmpty && (n[s] = Gs(i.swap(), t, e, u, l).swap());
  }
  return n;
}
...
function Ta(e, t, n) {
  ...
  function o(u, c) {
    ...
    for (; s.length > 0; ) {
      const w = s[0];
      if (!(w.seq1Range.intersects(d.seq1Range) || w.seq2Range.intersects(d.seq2Range)))
        break;
      const N = e.findWordContaining(w.seq1Range.start), b = t.findWordContaining(w.seq2Range.start), L = new z(N, b), _ = L.intersect(w);
      if (g += _.seq1Range.length, p += _.seq2Range.length, d = d.join(L), d.seq1Range.endExclusive >= w.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    g + p < (d.seq1Range.length + d.seq2Range.length) * 2 / 3 && r.push(d), i = d.getEndExclusives();
  }
  for (; s.length > 0; ) {
    const u = s.shift();
...
function qa(e, t, n) {
  ...
  do {
    ...
    for (let l = 1; l < s.length; l++) {
      ...
      h(c, u) ? (i = !0, o[o.length - 1] = o[o.length - 1].join(u)) : o.push(u);
    }
    s = o;
  } while (r++ < 10 && i);
  return s;
...
function Ba(e, t, n) {
    ...
    for (let u = 1; u < s.length; u++) {
      let f = function(m, g) {
        ...
        if (v.length > 20 || v.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const N = e.countLinesIn(m.seq1Range), b = m.seq1Range.length, L = t.countLinesIn(m.seq2Range), _ = m.seq2Range.length, R = e.countLinesIn(g.seq1Range), y = g.seq1Range.length, E = t.countLinesIn(g.seq2Range), I = g.seq2Range.length, G = 2 * 40 + 50;
        function S(x) {
          return Math.min(x, G);
        }
        return Math.pow(Math.pow(S(N * 40 + b), 1.5) + Math.pow(S(L * 40 + _), 1.5), 1.5) + Math.pow(Math.pow(S(R * 40 + y), 1.5) + Math.pow(S(E * 40 + I), 1.5), 1.5) > (G ** 1.5) ** 1.5 * 1.3;
      };
      const c = s[u], h = l[l.length - 1];
      f(h, c) ? (i = !0, l[l.length - 1] = l[l.length - 1].join(c)) : l.push(c);
    }
    s = l;
  } while (r++ < 10 && i);
  const o = [];
  return Dr(s, (l, u, c) => {
    ...
    const p = z.fromOffsetPairs(l ? l.getEndExclusives() : de.zero, c ? c.getStarts() : de.max), w = h.intersect(p);
    o.length > 0 && w.getStarts().equals(o[o.length - 1].getEndExclusives()) ? o[o.length - 1] = o[o.length - 1].join(w) : o.push(w);
  }), o;
}
class Os {
  constructor(t, n) {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : Xs(this.lines[t - 1]), s = t === this.lines.length ? 0 : Xs(this.lines[t]);
    return 1e3 - (n + s);
  }
  getText(t) {
...
class Ia {
  constructor() {
    this.dynamicProgrammingDiffing = new Na(), this.myersDiffingAlgorithm = new pr();
  }
  computeDiff(t, n, s) {
    if (t.length <= 1 && Mr(t, n, (_, R) => _ === R))
      return new dt([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new dt([
        new me(new F(1, t.length + 1), new F(1, n.length + 1), [
          new je(new D(1, 1, t.length, t[0].length + 1), new D(1, 1, n.length, n[0].length + 1))
        ])
      ], [], !1);
    const r = s.maxComputationTimeMs === 0 ? st.instance : new va(s.maxComputationTimeMs), i = !s.ignoreTrimWhitespace, o = /* @__PURE__ */ new Map();
    function l(_) {
      let R = o.get(_);
      return R === void 0 && (R = o.size, o.set(_, R)), R;
    }
    const u = t.map((_) => l(_.trim())), c = n.map((_) => l(_.trim())), h = new Os(u, t), f = new Os(c, n), d = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, r, (_, R) => t[_] === n[R] ? n[R].length === 0 ? 0.1 : 1 + Math.log(1 + n[R].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f);
    let m = d.diffs, g = d.hitTimeout;
    m = $s(h, f, m), m = qa(h, f, m);
    const p = [], w = (_) => {
      if (i)
        for (let R = 0; R < _; R++) {
          const y = v + R, E = N + R;
    ...
    let v = 0, N = 0;
    for (const _ of m) {
      Lt(() => _.seq1Range.start - v === _.seq2Range.start - N);
      const R = _.seq1Range.start - v;
      w(R), v = _.seq1Range.endExclusive, N = _.seq2Range.endExclusive;
    ...
    const b = Qs(p, t, n);
    let L = [];
    return s.computeMoves && (L = this.computeMoves(b, t, n, u, c, r, i)), Lt(() => {
      function _(y, E) {
  ...
  computeMoves(t, n, s, r, i, o, l) {
    return Ra(t, n, s, r, i, o).map((h) => {
      const f = this.refineDiff(n, s, new z(h.original.toOffsetRange(), h.modified.toOffsetRange()), o, l), d = Qs(f.mappings, n, s, !0);
      return new hn(h, d);
    });
  }
  refineDiff(t, n, s, r, i) {
    const o = new Nt(t, s.seq1Range, i), l = new Nt(n, s.seq2Range, i), u = o.length + l.length < 500 ? this.dynamicProgrammingDiffing.compute(o, l, r) : this.myersDiffingAlgorithm.compute(o, l, r);
    let c = u.diffs;
    return c = $s(o, l, c), c = Ta(o, l, c), c = Pa(o, l, c), c = Ba(o, l, c), {
      mappings: c.map((f) => new je(o.translateRange(f.seq1Range), l.translateRange(f.seq2Range))),
...
function Qs(e, t, n, s = !1) {
  const r = [];
  for (const i of kr(e.map((o) => Ua(o, t, n)), (o, l) => o.original.overlapOrTouch(l.original) || o.modified.overlapOrTouch(l.modified))) {
  ...
  return Lt(() => !s && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length - r[r.length - 1].modified.endLineNumberExclusive !== t.length - r[r.length - 1].original.endLineNumberExclusive) ? !1 : gr(r, (i, o) => o.original.startLineNumber - i.original.endLineNumberExclusive === o.modified.startLineNumber - i.modified.endLineNumberExclusive && i.original.endLineNumberExclusive < o.original.startLineNumber && i.modified.endLineNumberExclusive < o.modified.startLineNumber)), r;
}
function Ua(e, t, n) {
  let s = 0, r = 0;
...
class j {
  constructor(t, n, s, r = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, s)) | 0, this.a = Ne(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
...
class se {
  constructor(t, n, s, r) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = Ne(Math.max(Math.min(1, n), 0), 3), this.l = Ne(Math.max(Math.min(1, s), 0), 3), this.a = Ne(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    const h = (l + o) / 2, f = o - l;
    if (f > 0) {
      switch (c = Math.min(h <= 0.5 ? f / (2 * h) : f / (2 - 2 * h), 1), o) {
        case n:
          u = (s - r) / f + (s < r ? 6 : 0);
          break;
        case s:
  ...
  static toRGBA(t) {
    ...
    if (s === 0)
      ...
      o = se._hue2rgb(h, c, n + 1 / 3), l = se._hue2rgb(h, c, n), u = se._hue2rgb(h, c, n - 1 / 3);
    }
    return new j(Math.round(o * 255), Math.round(l * 255), Math.round(u * 255), i);
  }
}
class Te {
  constructor(t, n, s, r) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = Ne(Math.max(Math.min(1, n), 0), 3), this.v = Ne(Math.max(Math.min(1, s), 0), 3), this.a = Ne(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return l === 0 ? c = 0 : i === n ? c = ((s - r) / l % 6 + 6) % 6 : i === s ? c = (r - n) / l + 2 : c = (n - s) / l + 4, new Te(Math.round(c * 60), u, i, t.a);
  }
  static toRGBA(t) {
    const { h: n, s, v: r, a: i } = t, o = r * s, l = o * (1 - Math.abs(n / 60 % 2 - 1)), u = r - o;
    let [c, h, f] = [0, 0, 0];
    return n < 60 ? (c = o, h = l) : n < 120 ? (c = l, h = o) : n < 180 ? (h = o, f = l) : n < 240 ? (h = l, f = o) : n < 300 ? (c = l, f = o) : n <= 360 && (c = o, f = l), c = Math.round((c + u) * 255), h = Math.round((h + u) * 255), f = Math.round((f + u) * 255), new j(c, h, f, i);
  }
}
const q = class q {
  static fromHex(t) {
  ...
  equals(t) {
    return !!t && j.equals(this.rgba, t.rgba) && se.equals(this.hsla, t.hsla) && Te.equals(this.hsva, t.hsva);
  }
  ...
  blend(t) {
    ...
    const o = this.rgba.r * s / i + n.r * r * (1 - s) / i, l = this.rgba.g * s / i + n.g * r * (1 - s) / i, u = this.rgba.b * s / i + n.b * r * (1 - s) / i;
    return new q(new j(o, l, u, i));
  }
  makeOpaque(t) {
...
q.white = new q(new j(255, 255, 255, 1)), q.black = new q(new j(0, 0, 0, 1)), q.red = new q(new j(255, 0, 0, 1)), q.blue = new q(new j(0, 0, 255, 1)), q.green = new q(new j(0, 255, 0, 1)), q.cyan = new q(new j(0, 255, 255, 1)), q.lightgrey = new q(new j(211, 211, 211, 1)), q.transparent = new q(new j(0, 0, 0, 0));
let Ge = q;
(function(e) {
  (function(t) {
    (function(n) {
      ...
      function f(m) {
        ...
        if (g === 0 || m.charCodeAt(0) !== 35)
          return null;
        if (g === 7) {
          const p = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), w = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), v = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6));
          return new e(new j(p, w, v, 1));
        }
        if (g === 9) {
          const p = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), w = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), v = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6)), N = 16 * d(m.charCodeAt(7)) + d(m.charCodeAt(8));
          return new e(new j(p, w, v, N / 255));
        }
        if (g === 4) {
          const p = d(m.charCodeAt(1)), w = d(m.charCodeAt(2)), v = d(m.charCodeAt(3));
          return new e(new j(16 * p + p, 16 * w + w, 16 * v + v));
        }
        if (g === 5) {
          const p = d(m.charCodeAt(1)), w = d(m.charCodeAt(2)), v = d(m.charCodeAt(3)), N = d(m.charCodeAt(4));
          return new e(new j(16 * p + p, 16 * w + w, 16 * v + v, (16 * N + N) / 255));
        }
        return null;
      }
      n.parseHex = f;
...
function Ys(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), i = _r(r), o = new Ge(new se(
    i[0],
    i[1] / 100,
    i[2] / 100,
    n ? i[3] : 1
  ...
  return {
    range: e,
    color: fn(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a)
  };
}
function Qe(e, t) {
...
function Wa(e) {
  const t = [], s = Qe(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (s.length > 0)
    for (const r of s) {
...
function za(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : Wa(e);
}
const Zs = new RegExp("\\bMARK:\\s*(.*)$", "d"), $a = /^-+|-+$/g;
function ja(e, t) {
  var s;
  let n = [];
...
function wr(e) {
  ...
  return e = e.replace($a, ""), { text: e, hasSeparatorLine: t };
}
class Qa extends Gi {
  get uri() {
    return this._uri;
  ...
  findMatches(t) {
    ...
    for (let s = 0; s < this._lines.length; s++) {
      const r = this._lines[s], i = this.offsetAt(new J(s + 1, 1)), o = r.matchAll(t);
      for (const l of o)
  ...
  getWordAtPosition(t, n) {
    const s = ln(t.column, dr(n), this._lines[t.lineNumber - 1], 0);
    return s ? new D(
      t.lineNumber,
      s.startColumn,
      t.lineNumber,
...
const we = class we {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new Qa(ye.parse(t.url), t.lines, t.EOL, t.versionId);
  }
  ...
  async computeUnicodeHighlights(t, n, s) {
    ...
    return r ? ba.computeUnicodeHighlights(r, n, s) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async computeDiff(t, n, s, r) {
    ...
    return !i || !o ? null : we.computeDiff(i, o, s, r);
  }
  static computeDiff(t, n, s, r) {
    const i = r === "advanced" ? Pt.getDefault() : Pt.getLegacy(), o = t.getLinesContent(), l = n.getLinesContent(), u = i.computeDiff(o, l, s), c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function h(f) {
      return f.map(
        (d) => {
          var m;
  ...
  async computeDirtyDiff(t, n, s) {
    ...
    if (!r || !i)
      return null;
    const o = r.getLinesContent(), l = i.getLinesContent();
    return new xr(o, l, {
  ...
  async computeMoreMinimalEdits(t, n, s) {
    ...
    for (let u = 1; u < n.length; u++)
      D.getEndPosition(n[l].range).equals(D.getStartPosition(n[u].range)) ? (n[l].range = D.fromPositions(D.getStartPosition(n[l].range), D.getEndPosition(n[u].range)), n[l].text += n[u].text) : (l++, n[l] = n[u]);
    n.length = l + 1;
    for (let { range: u, text: c, eol: h } of n) {
      if (typeof h == "number" && (o = h), D.isEmpty(u) && !c)
        continue;
      const f = r.getValueInRange(u);
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), f === c)
        continue;
      if (Math.max(c.length, f.length) > we._diffLimit) {
        i.push({ range: u, text: c });
        continue;
      }
      const d = Ai(f, c, s), m = r.offsetAt(D.lift(u).getStartPosition());
      for (const g of d) {
        const p = r.positionAt(m + g.originalStart), w = r.positionAt(m + g.originalStart + g.originalLength), v = {
  ...
  computeHumanReadableDiff(t, n, s) {
    ...
    n = n.slice(0).sort((l, u) => {
      if (l.range && u.range)
        return D.compareRangesUsingStarts(l.range, u.range);
    ...
    for (let { range: l, text: u, eol: c } of n) {
      let p = function(v, N) {
        ...
        for (let L = N.startLineNumber; L <= N.endLineNumber; L++) {
          const _ = v[L - 1];
          L === N.startLineNumber && L === N.endLineNumber ? b.push(_.substring(N.startColumn - 1, N.endColumn - 1)) : L === N.startLineNumber ? b.push(_.substring(N.startColumn - 1)) : L === N.endLineNumber ? b.push(_.substring(0, N.endColumn - 1)) : b.push(_);
        }
        return b;
      };
      if (typeof c == "number" && (o = c), D.isEmpty(l) && !u)
        continue;
      const h = r.getValueInRange(l);
      if (u = u.replace(/\r\n|\n|\r/g, r.eol), h === u)
        continue;
      if (Math.max(u.length, h.length) > we._diffLimit) {
        i.push({ range: l, text: u });
        continue;
      }
      const f = h.split(/\r\n|\n|\r/), d = u.split(/\r\n|\n|\r/), m = Pt.getDefault().computeDiff(f, d, s), g = D.lift(l).getStartPosition();
      for (const v of m.changes)
        if (v.innerChanges)
          for (const N of v.innerChanges)
            i.push({
              ...
              text: w(d, N.modifiedRange).join(r.eol)
            });
        else
  ...
  async textualSuggest(t, n, s, r) {
    const i = new yt(), o = new RegExp(s, r), l = /* @__PURE__ */ new Set();
    e:
      for (const u of t) {
        const c = this._getModel(u);
        if (c) {
          for (const h of c.words(o))
            if (!(h === n || !isNaN(Number(h))) && (l.add(h), l.size > we._suggestionsLimit))
              break e;
        }
      }
  ...
  loadForeignModule(t, n, s) {
    const o = {
      host: Qr(s, (l, u) => this._host.fhr(l, u)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(o, n), Promise.resolve(Ut(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"));
  }
  fmr(t, n) {
...
we._diffLimit = 1e5, we._suggestionsLimit = 1e4;
let rn = we;
typeof importScripts == "function" && (globalThis.monaco = ca());
let an = !1;
function Ja(e) {
  if (an)
    return;
